<div class="flex flex-col gap-3 py-3 px-2 w-full">
    @php
        $record = $getRecord();
        $showResult = $record->show_result_to_student;
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 items-start">
            ...
            <div class="flex flex-col gap-1">
                ...
                <div
                    ...
                    @if ($max > 0)
                        {{ $score }} <span class="mx-1 text-blue-300 dark:text-blue-700">/</span>
                        {{ $max }}
                    @else
                        {{ $score }}
                    @endif
                    ...
                    <div class="flex flex-col gap-0.5">
                        ...
                        @else
                            <div class="flex flex-col gap-1.5">
                                ...
                                <span class="text-[10px] text-gray-400 italic font-medium leading-none">Menunggu
                                    finalisasi
                                    pengajar</span>
                            </div>
                        @endif
